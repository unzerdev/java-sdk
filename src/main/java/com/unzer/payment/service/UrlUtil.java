...
public class UrlUtil {
    ...
    private final String endPoint; // TODO: what is that?
    ...
    public String getHttpGetUrl(Resource resource, String id) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(getRestUrl(resource));
        appendSlashIfNeeded(stringBuilder);
        stringBuilder.append(id);
        return stringBuilder.toString();
    }
    ...
    public String getRestUrl(Resource resource) {
        return getRestUrlInternal(resource).replace("<paymentId>/", "");
    }
    ...
    private String getRestUrlInternal(Resource resource) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(getRestUrl());
        appendSlashIfNeeded(stringBuilder);
        stringBuilder.append(resource.getResourceUrl());
        return stringBuilder.toString();
    }
