...
public class PaylaterInstallmentPlans {
    ...
    public PaylaterInstallmentPlans map(PaylaterInstallmentPlans installmentPlans, JsonInstallmentPlans jsonInstallmentPlans) {
...
//            ((PaylaterInstallmentPlans) installmentPlans).setPlans(jsonInstallmentPlans.getPlans());
    ...
    private void map(List<InstallmentPlan> installmentPlan, List<JsonInstallmentPlan> jsonInstallmentPlan) {
    ...
    private void mapRates(List<InstallmentPlanRate> installmentPlanRates, List<JsonInstallmentPlanRate> json) {
        json.forEach((rate) -> {
