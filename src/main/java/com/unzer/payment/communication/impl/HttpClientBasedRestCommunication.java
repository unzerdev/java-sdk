...
import com.unzer.payment.communication.HeidelpayHttpResponse;
...
public class HttpClientBasedRestCommunication extends AbstractHeidelpayRestCommunication {
	...
	@Override
	protected HeidelpayHttpRequest createRequest(String url, HeidelpayHttpRequest.HeidelpayHttpMethod method) {
