...
public class BasketV1TestData {
    ...
    public static Basket getMaxTestBasketV1() {
        ...
        basket.setAmountTotalVat(BigDecimal.valueOf(380.48 * 0.2).setScale(2, RoundingMode.HALF_UP));
    ...
    protected Basket getTestBasketV1ForInvoice() {
        ...
        basket.setAmountTotalVat(BigDecimal.valueOf(14.49 * 0.2).setScale(2, RoundingMode.HALF_UP));
